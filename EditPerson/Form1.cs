...
namespace EditPerson
{
    public partial class Gender : Form
    {
        ...
        public Gender(Person person, Form parentForm)
        {
            InitializeComponent();
            ...
            */
            ...
            {
                if (student1.eCollegeYear == collegeYear.freshman)
                {
                    froshRadioButton.Checked = true;
                }

                else if (student1.eCollegeYear == collegeYear.sophomore)
                {
                    sophRadioButton.Checked = true;
                }

                else if (student1.eCollegeYear == collegeYear.junior)
                {
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            else if (student.eCollegeYear == collegeYear.senior)
            {
        ...
        private void froshRadioButton_CheckedChanged_1(object sender, EventArgs e)
        {
