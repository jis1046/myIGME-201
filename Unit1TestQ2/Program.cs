...
namespace NumberSort
{
    class Program
    {
        ...
        start:
            Console.WriteLine("Numbers or sentence?");
            ...
            if (answer == "sentence")
            {
                ...
                foreach (string thisSentence in sentence)
                {
                ...
                foreach (string thisSentence in sentence)
                {
                    ...
                    string str = aUnsorted[nUnsortedLength].ToString(thisSentence);
            ...
            {
                Console.WriteLine("Enter a list of space-separated numbers or sentence");
        ...
        static double FindFirstAlphabet(double[] array)
        {
            // define return value
            double returnVal;
            ...
            // loop through the array
            foreach (string thisSentence in array)
            {
                // if the current value is less than the saved lowest value
                if (thisSentence < returnVal)
                {
                    // save this as the lowest value
                    returnVal = thisSentence;
                }
            }
        ...
        static double FindLastAlphabet(double[] array)
        {
            // define return value
            double returnVal;
