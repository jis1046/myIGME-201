...
namespace MyEditor
{
    public partial class Form1 : Form
    {
        public Form1()
        {
            ...
            this.timesNewRoamnToolStripMenuItem.Click += new EventHandler(TimesNewRoamnToolStripMenuItem__Click);
        ...
        {
            Font newFont = new Font("MS San Serif", richTextBox.SelectionFont.Size, richTextBox.SelectionFont.Style);

            richTextBox.SelectionFont = newFont;
        }

        private void TimesNewRoamnToolStripMenuItem__Click(object sender, EventArgs e)
        {
