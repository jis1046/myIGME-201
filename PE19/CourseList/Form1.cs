...
namespace CourseList
{
    public partial class CourseListForm : Form
    {
        public CourseListForm()
        {
            ...
            courseListView.Location = (1, 2);
            courseListView.MultiSelect = False;
            courseListView.Size: (798, 348);
            ...
            this.courseListView__ItemActivate += new KeyEventHandler(CourseListView__ItemActivate);
            ...
            this.courseListView__KeyDown += new KeyEventHandler(CourseListView__KeyDown);
            ...
            this.courseListView__SelectedIndexChanged += new KeyEventHandler(CourseListView__SelectedIndexChanged);
        ...
        public void PaintListView(string firstCourseCode)
        {
            ...
            if(firstCourseCode == courseListView.indexOf(0))
            {
             ...
             foreach (course in sortedList)
            {
                ...
                lvi.Columns.Add(thisCourse.courseCode);
                ...
                if (lvi.CourseListView.indexOf(0))
                {
        ...
        private void CourseListView__ItemActivate(object sender, EventArgs e)
        {
            ...
            ListViewItem.selectedItem = courseCode.IndexOfKey(e);

            // 40. get the course object associated with this courseCode from Globals.courses SortedList
            Globals.courses.sortedList.IndexOfKey(courseCode);
            ...
            if (course != null)
            {
                ...
                courseCodeDescriptionTextBox.Text = course.description;
        ...
        private void CourseListView__KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (this.courseListView__KeyDown == true )
            {
